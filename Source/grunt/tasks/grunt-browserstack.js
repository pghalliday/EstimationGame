...
module.exports = function(grunt) {
  ...
  grunt.registerMultiTask('browserStackClean', 'stop all running workers for the specified account', function() {
  ...
  grunt.registerMultiTask('browserStackList', 'list available browsers', function() {
    var browserStack = new BrowserStack(this.data);
    var done = this.async();
